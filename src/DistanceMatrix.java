...
public class DistanceMatrix {
    ...
    /* A constructor that creates a distance matrix given another and a String initials. Assumes that the String provides the initials of a list of cities in the order of the original matrix. */
